...
@Component({
  ...
  styleUrls: ['../../../theme/utilities.scss', './otros.page.scss'],
})
export class OtrosPage implements OnInit {
  ...
  constructor(private router: Router,
              ...
              async detail(item){
                this.menuService.getMenuDetail('otros', item.id).subscribe(opciones => {
                ...
                const modal = await this.modalCtrl.create({
                  ...
                  componentProps: {
                    ...
                    precio: item.precio,
                    imagen: item.imagen,
                    opciones: this.menuService.getMenuDetail('otros', item.id)
                  }
                });
