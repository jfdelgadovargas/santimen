...
@Component({
  ...
  styleUrls: ['../../../theme/utilities.scss', './perros.page.scss'],
})
export class PerrosPage implements OnInit {
  ...
  constructor(private router: Router,
              ...
              async detail(item){
                this.menuService.getMenuDetail('perros', item.id).subscribe(opciones => {
                ...
                const modal = await this.modalCtrl.create({
                  ...
                  componentProps: {
                    ...
                    precio: item.precio,
                    imagen: item.imagen,
                    opciones: this.menuService.getMenuDetail('perros', item.id)
                  }
                });
